  ...
  component: () => {
    return (
      <main className="z-10 bg-[#001d2e]">
        ...
        <section className="bg-[#002E46] w-[70%] flex items-center justify-center rounded-[28px] pr-[40px] py-[40px] gap-[32px] mx-auto">
          <div className="w-[80%]">
            <img
          ...
          <div className="flex flex-col gap-[20px]">
            ...
            <Button className="border-[3px] border-blue-900 text-blue-900 font-bold text-xl px-10 py-10 rounded-[14px] w-[30%] bg-[#002E46]">
              Create Farm
            </Button>
          </div>
        </section>
        <section className="flex items-center justify-center bg-[#002E46] mt-[40px] px-[20%] gap-[20px]">
          <div className="w-[50%] flex flex-col gap-[20px]">
            ...
            <div className="flex gap-[20px]">
              ...
              <Button className="border-[3px] border-blue-900 text-blue-900 font-bold text-xl px-10 py-10 rounded-[14px] bg-[#002E46]">
                View Our Pack
              </Button>
            </div>
          </div>
        ...
        <section className="mt-[40px]">
          <h1 className="text-center uppercase text-white text-[24px] font-semibold">
            As Seen In
          </h1>
